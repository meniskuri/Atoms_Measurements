...
% CMC
MnZn_Core_SM_CMC = load('SM_181U_15A_REV_IMP_Rea_Imag_V4.dat'); % V4
...
title('SM Z (Magn)  CMC V4; (Turns = 4) core MnZn 744-632-600-2')
grid on
...
xlabel('Frequency [Hz]')
ylabel('magn [\Omega]')
legend('CM 181U 15A REV.B','SM Z magn (CMC)')
title('SM Z (Magn)  CMC V4; (Turns = 4) core MnZn 744-632-600-2')
grid on
...
L_model_V4 = [MnZn_Core_SM_CMC(:,1),((MnZn_Core_SM_CMC(:,3))./(2*pi*MnZn_Core_SM_CMC(:,1))).*1e6];

save('L_uH_Model_V4.dat','L_model_V4','-ascii')
