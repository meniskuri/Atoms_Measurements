...
% CMC
MnZn_Core_SM_CMC = load('SM_181U_15A_REV_IMP_Rea_Imag_V1.dat'); % V1 
...
title('SM Z (Magn)  CMC V1; (Turns = 5) mu=3700; f = 400kHz')
grid on
...
% L_model_V1 = [MnZn_Core_SM_CMC(:,1),((MnZn_Core_SM_CMC(:,3))./(2*pi*MnZn_Core_SM_CMC(:,1))).*1e6];
% 
% save('L_uH_Model_V1.dat','L_model_V1','-ascii')
